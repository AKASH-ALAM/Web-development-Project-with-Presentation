    	...
    	<div id="slider" style="float:left">
            ...
            <img src="images/img_5.png"/>
             ...
             <div class="ex"><div class="heading">ANNOUNCEMENTS</div><br/><div class="low">
                         ...
                         <li class="one">Board meeting on 11/07/2018<br/><br/></li>
                         <li class="two">Withdrawal limit of ATM rises<br/> from Tk 25000 to Tk 40000<br/><br/></li>
                         ...
                         <li class="five">New account for BPL certificate <br/> holders for only 100Tk.<br/></li>
                         </ul>
