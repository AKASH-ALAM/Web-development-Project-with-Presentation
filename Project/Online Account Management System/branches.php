...
<div id="toptabmenu">
    <ul id="nav">
     ...
     <div id="templatemo_main">
        <div class="image view"><img src="images/iron bank.jpg" alt="The RS Bank" title="The RS Bank" /><div class="mask">  
     <h2>CHAIRMAN</h2>  
     <p>Mr. Robioul Islam</p><br/><br/>
     <h2>EXECUTIVE DIRECTOR</h2>  
     <p>Babuni(RS)</p>
     
     </div></div>
         <div class="brcont"><h2>The RS Bank</h2><br/>Our branch in New York city is also popularly known as "The Iron Bank", named after the legendary RS. 
             As Robioul Islam newest financial institution, the Iron Bank has a proud tradition of providing friendly, 
