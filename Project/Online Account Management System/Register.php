...
<div id="templatemo_wrapper">
    ...
    <div class="mainbox">
        ...
        <div id="site_title">
            ...
            <h1 style="margin-top: 30px;"><a href="index.php" style="color:yellow; text-decoration: none; margin-left: 1em;"><span>Online Accounting System</span></a></h1>
            <p style="float:right; margin-right: 2.2em; color: buttonface; font-family: Satisfy,cursive; font-size: 2.5em;">.......Robiul Islam</p>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="Day" class="ddlist">
                                <?php $day = array("Banladesh","USA","England");
                                for ($i=0;$i<3;$i++)
