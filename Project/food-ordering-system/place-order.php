...
<?php
    ...
    echo '<li class="collection-item">
        <div class="row">
            ...
            <div class="col s3">
                <span><strong>'.$total.'tk</strong></span>
            </div>
        </div>
    </li>';
...
?>
  ...
  <footer class="page-footer">
    ...
    <div class="container">
        <span>©2019 <a class="grey-text text-lighten-4" href="#" target="_blank">Sky Food</a> All rights reserved.</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">Mb Labu mia</a></span>
      </div>
    </div>
  </footer>
    <!-- END FOOTER -->
