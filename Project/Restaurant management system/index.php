    ...
    <div class="welcome-message">
        <div class="wrap-info">
            <div class="information">
                <h1  class="animated fadeInDown">Best hotel in Sylhet</h1>
                <p class="animated fadeInUp">Most luxurious hotel in Sylhet with the royal treatments and excellent customer service.</p>                
            </div>
            
        </div>
    </div>
</div>
<img src="images/photos/6.jpg" height="500" width="1270" ></img>
<!-- banner-->
